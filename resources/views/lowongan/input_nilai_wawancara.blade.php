                                  ...
                                  <form method="post" action="#">   
                                      <div class="row 50%">           
                                          ...
                                          <div class="10u 12u(mobile)">
                                              <input required name="n_penampilan" placeholder="Nilai Penampilan. Misal: 4" type="number" max="5" min="0" step="1" required/>
                                          </div>
                                      </div>
                                      <div class="row 50%">           
                                          <div class="2u 12u(mobile)">Wawasan</div>
                                          <div class="10u 12u(mobile)">
                                              <input required name="n_wawasan" placeholder="Nilai Wawasan. Misal: 4" type="number" max="5" min="0" step="1" required/>
                                          </div>
                                      </div>
                                      <div class="row 50%">           
                                          <div class="2u 12u(mobile)">Sikap</div>
                                          <div class="10u 12u(mobile)">
                                              <input required name="n_sikap" placeholder="Nilai Sikap. Misal: 4" type="number" max="5" min="0" step="1" required/>
                                          </div>
                                      </div>
                                      <div class="row 50%">           
                                          <div class="2u 12u(mobile)">Bahasa Asing</div>
                                          <div class="10u 12u(mobile)">
                                              <select name="n_bahasa">
                                                  <option> --- </option>
                                                  <option>Ya</option>
                                                  <option>Tidak</option>
                                              </select>
